...
(function() {
  'use strict';
  var Glob, checkIfValid, colors, confirmWithUser, find, findSync, fs, getConfigs, list, main, path, printHelp, readline, remove, rename, yargs, _,
    __slice = [].slice;
  ...
  main = function(argv) {
    ...
    if (isConfigsValid) {
      ...
      if (configs.help) {
        ...
        return findSync(configs.destination, configs.extnames, remove, configs.verbose);
      } else {
